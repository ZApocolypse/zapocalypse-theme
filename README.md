...
*zapocalypse is a Jekyll theme for GitHub Pages. You can [preview the theme to see what it looks like](https://zapocolypse.github.io/zapocalypse-theme), or even [use it today](#usage).*

![Thumbnail of zapocalypse](thumbnail.png)

## Usage

To use the zapocalypse theme:
...
zapocalypse will respect the following variables, if set in your site's `_config.yml`:
...
The zapocalypse theme is intended to make it quick and easy for GitHub Pages users to create their first (or 100th) website. The theme should meet the vast majority of users' needs out of the box, erring on the side of simplicity rather than flexibility, and provide users the opportunity to opt-in to additional complexity if they have specific needs or wish to further customize their experience (such as adding custom CSS or modifying the default layout). It should also look great, but that goes without saying.

## Contributing

Interested in contributing to zapocalypse? We'd love your help. zapocalypse is an open source project, built one contribution at a time by users like you. See [the CONTRIBUTING file](docs/CONTRIBUTING.md) for instructions on how to contribute.
